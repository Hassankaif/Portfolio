      ...
      <div className="p-6">
        ...
        <div className="flex justify-between gap-4">
          ...
          <a
            ...
            className="w-full"
          >
            <button type="button" class="text-white bg-[#FF0000] hover:bg-[#FF0000]/90 focus:ring-4 focus:outline-none focus:ring-[#FF0000]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-red-500 dark:hover:bg-[#7F0000]/30 me-2 mb-2">
